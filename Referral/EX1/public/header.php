...
<body class="bg-info">
	...
	<div class="row" >
            <a href="index.php"><img class="navbar-brand" src="public/images/socem_logo.jpg" alt="School logo" /></a>
	</div>
	...
	<ul class="nav navbar-nav navbar-center">
            <li><h2>SOFT 165 Web Development<span class='sr-only'>(current)</span></h2></li>
	</ul>		
	</div>
        <div>
